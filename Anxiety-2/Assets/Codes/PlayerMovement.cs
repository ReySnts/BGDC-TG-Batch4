...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            rigidBody.velocity = Vector3.right * x * walkSpeed * 0.5f;
            shadow.localScale = new Vector3(1f, 0.5f, 0.5f);
        ...
        // Run
            ...
            rigidBody.velocity = Vector3.right * x * walkSpeed * 2f;
        // Normal
        else
        {
            rigidBody.velocity = Vector3.right * x * walkSpeed;
            isCrouch = false;
        }
        tempX = x;
